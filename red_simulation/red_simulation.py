...
label(pos=vector(12,-5,0),text="Red : Congestion",depth=0.3,color=color.white)
...
red = box(pos=vector(0,0,0),color=color.red,width=0.2,length=30,height=1.2)
...
for i in range(50): # repeat for _ times
	vehicle_movement()
